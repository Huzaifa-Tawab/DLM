...
import SubmitForBalloting from "../../components/Modals/SubmitForBalloting";
                      ...
                      PromosWithStatus.map((promo, index) => (
                        ...
                        >
                          ...
                          <div className="flex-justify">
                            ...
                            <h3>
                              {calculateRemainingHours(promo.endsAt.toDate())}
                              hrs left
                            </h3>
                          </div>
                        </div>
