...
const navi=useNavigate();
  ...
  return(
isLoading?<Loader/>:  <div className='main-page'>
<div className='top-head'>
  <h1>DYNAMIC LAND MANAGEMENT</h1>

  <div className='top-sec-cont'><h3>BOOKING FORM</h3></div>
  
  <h3 className='top-thrd-cont'>File No: <span>{FileNumber}</span></h3>
</div>
...
<div className='head-content'>
  <p>Date: {FDate}</p>
   ...
   <div className='imgtop'><img src={UserImage}></img></div>
   <p className='sec-section-last'>Dear Sir/ Madam,<br/><span>I Undertake to be bounded by all such conditions, obligations and responsibilities as printed overleaf in this respect, make there under.</span></p>
   </div>
   <div className='top-sec-heading'><h3>PERSONAL INFORMATION</h3></div>
  ...
  <div className='top-sec-heading'><h3>NEXT TO KIN</h3></div>
  ...
  <div className='top-sec-heading'><h3>BOOKING DETAILS</h3></div>
  ...
  <div className='top-sec-heading'><h3>CONTRACT DETAILS</h3></div>
   <div className='sectop-section-content'>
