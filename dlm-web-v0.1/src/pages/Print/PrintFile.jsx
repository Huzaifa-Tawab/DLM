      ...
      <div className="sec-section">
        <div className="head-top-cont">
          ...
          <p className="sec-section-last">
            ...
            <br />
            <span>
              I Undertake to be bounded by all such conditions, obligations and
              responsibilities as printed overleaf in this respect, make there
              under.
            </span>
          </p>
        </div>
        ...
        <div className="last-text-content">
          <span>Note:</span>Permission of plot will be as per schedule i.e 62
